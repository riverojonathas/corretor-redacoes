            ...
            <div className="bg-[#fdfaf2] border border-[#eee9df] w-full max-w-md rounded-3xl shadow-2xl relative z-10 p-8 animate-in zoom-in-95 duration-300">
                ...
                <div className="flex flex-col gap-3">
                    <button
                        ...
                        className="w-full py-3.5 bg-accent-red text-white font-black uppercase tracking-widest text-xs rounded-xl shadow-lg shadow-accent-red/20 hover:scale-[1.02] active:scale-[0.98] transition-all"
                    >
                    ...
                    <button
                        onClick={onCancel}
                        className="w-full py-3.5 text-gray-400 font-bold hover:text-dark-gray transition-all text-[10px] uppercase tracking-wider"
                    >
                        Cancelar
                    </button>
                </div>
